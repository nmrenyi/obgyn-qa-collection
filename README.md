...
| [Kenya Clinical Vignettes](kenya-clinical-vignettes/) | 284 vignettes | Nurse-written clinical cases | Kenya | [Mwaniki et al., 2025](https://doi.org/10.1101/2025.10.25.25338798) |
...
Obstetrics & Gynecology (10,237) and Pediatrics (8,271) questions extracted from the MedMCQA dataset, sourced from Indian AIIMS and NEET PG entrance exams. Each question has 4 options, a correct answer, and an expert explanation (available for ~96% of questions).
